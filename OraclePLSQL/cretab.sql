...
PROMPT
PROMPT "demopl" User Creating...
CREATE USER demopl
IDENTIFIED BY plsql;
GRANT CONNECT,RESOURCE,UNLIMITED TABLESPACE TO demopl;
GRANT CREATE SYNONYM TO demopl;
GRANT CREATE ROLE TO demopl;
GRANT CREATE VIEW TO demopl;

PROMPT
PROMPT "demopl" 's DATA Creating...
CONNECT demopl/plsql
